...
class Billing extends JFrame implements ActionListener
{
	...
	JTextField Customer_Id = (JTextField)Class.forName( "javax.swing.JTextField" ).newInstance();
	JTextField Job_Id = (JTextField)Class.forName( "javax.swing.JTextField" ).newInstance();
	...
	JTextField Gross_Due = new JTextField(10);
	...
	public JInternalFrame BillingFrame(JDesktopPane desktop)
	{
		...
		JLabel l_Gross_Due =new JLabel("         Gross Duedate :");
		l_Gross_Due.setBounds(50,240,150,20);
		iFrameBilling.add(l_Gross_Due);
